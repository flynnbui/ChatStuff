...
namespace ChatStuff.Infrastructure.Migrations
{
    ...
    [Migration("20240824121949_FriendsCreate")]
    partial class FriendsCreate
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ChatStuff.Core.Entities.ChatStuffUser", b =>
                {
                    ...
                    b.Property<List<string>>("ReceivedFriendRequests")
                        .IsRequired()
                        .HasColumnType("text[]");
                    ...
                    b.Property<List<string>>("SentFriendRequests")
                        .IsRequired()
                        .HasColumnType("text[]");
